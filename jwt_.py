...
# Create a fake db:
FAKE_DB = {
    'mettaminne@gmail.com': {'name': 'Guillermo Paoletti'},
    'djanezashvili@gmail.com': {'name': 'Guillermo Paoletti'}}
...
API_ACCESS_TOKEN_EXPIRE_MINUTES = cast_to_number('API_ACCESS_TOKEN_EXPIRE_MINUTES') or 24 * 60
