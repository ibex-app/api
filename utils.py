...
def collect_data_cmd(monitor_id:str, sub_domain:str, sample:bool = False):
    cmd = f'python3 /root/data-collection-and-processing/main.py --env={sub_domain} --monitor_id={monitor_id} {"--sample" if sample else ""} >> /var/log/ibex/celery_{sub_domain}.out'
